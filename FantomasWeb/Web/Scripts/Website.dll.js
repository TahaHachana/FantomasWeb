  ...
  Website:{
   ...
   Fantomas:{
    Client:{
     ...
     main:function()
     {
      var textArea,_this,_textArea_,_this1,formatBtn,x,el,_this2,inner,f,x1,_this3,_this4,_this5,_this6,arg002,_this7,arg003,_this8,arg004;
      ...
      formatBtn=(x=(el=Default.Button(List.ofArray([Default.Attr().Class("btn btn-primary btn-large"),(_this2=Default.Attr(),_this2.NewAttr("style","float: left;"))])),(inner=Default.Text("Format"),Operators.add(el,List.ofArray([inner])))),(f=(x1=function(elt)
      {
       return function()
       {
        ...
        x2=(f1=function()
        {
         ...
         {
          var a,code,b,f3,f4;
          a=_arg11.$==1?(code=_arg11.$0,(_textArea_.set_Value(code),(Client1.displayAlert(true),Concurrency.Return(null)))):(Client1.displayAlert(false),Concurrency.Return(null));
          b=(f3=function()
          {
