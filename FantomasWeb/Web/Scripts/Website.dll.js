(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,Website,AddThis,WebSharper,Html,Default,HTML5,List,T,Config,Client,Operators,jQuery,EventsPervasives,Remoting,Fantomas,Client1,Concurrency,ForkMe;
  ...
  Website:{
   ...
   Fantomas:{
    Client:{
     ...
     {
      var x,el,inner,f,x1;
      x=(el=Default.Button(List.ofArray([Default.Attr().Class("btn btn-primary btn-large")])),(inner=Default.Text("Format"),Operators.add(el,List.ofArray([inner]))));
      f=(x1=function(elt)
      {
       return function()
       {
        ...
        x2=(f1=function()
        {
         var objectArg,arg00,loaderJq,formattedJq,htmlJq,previewJq,config,code,x3,f2,x4,f3;
         ...
         f3=function(_arg1)
         {
          ...
          a=_arg1.$==1?(html=_arg1.$1,(code1=_arg1.$0,(formattedJq.val(code1),(htmlJq.val(html).click(function()
          {
